...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Networking-and-Content-Delivery/Res_AWS-Cloud-WAN_Core-Network-Edge_48"),
...
render.aliasName = "Aws Cloud Wan Core Network Edge";
