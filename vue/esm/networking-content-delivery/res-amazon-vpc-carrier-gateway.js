...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Networking-and-Content-Delivery/Res_Amazon-VPC_Carrier-Gateway_48"),
...
render.aliasName = "Amazon Vpc Carrier Gateway";
