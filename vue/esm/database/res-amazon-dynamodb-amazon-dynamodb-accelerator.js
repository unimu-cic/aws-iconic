...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Database/Res_Amazon-DynamoDB_Amazon-DynamoDB-Accelerator_48"),
...
render.aliasName = "Amazon Dynamodb Amazon Dynamodb Accelerator";
