...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Database/Res_Amazon-DynamoDB_Standard-Infrequent-Access-Table-Class_48"),
...
render.aliasName = "Amazon Dynamodb Standard Infrequent Access Table Class";
