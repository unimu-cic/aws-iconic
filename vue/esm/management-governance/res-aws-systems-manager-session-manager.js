...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Management-Governance/Res_AWS-Systems-Manager_Session-Manager_48"),
...
render.aliasName = "Aws Systems Manager Session Manager";
