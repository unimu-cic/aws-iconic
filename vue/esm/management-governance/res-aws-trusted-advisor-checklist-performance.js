...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Management-Governance/Res_AWS-Trusted-Advisor_Checklist-Performance_48"),
...
render.aliasName = "Aws Trusted Advisor Checklist Performance";
