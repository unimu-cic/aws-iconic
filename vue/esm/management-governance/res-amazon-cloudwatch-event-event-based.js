...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Management-Governance/Res_Amazon-CloudWatch_Event-Event-Based_48"),
...
render.aliasName = "Amazon Cloudwatch Event Event Based";
