...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Analytics/Res_Amazon-OpenSearch-Service_UltraWarm-Node_48"),
...
render.aliasName = "Amazon Openseservice Ultrawarm Node";
