...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Analytics/Res_Amazon-OpenSearch-Service_OpenSearch-Dashboards_48"),
...
render.aliasName = "Amazon Openseservice Opensedashboards";
