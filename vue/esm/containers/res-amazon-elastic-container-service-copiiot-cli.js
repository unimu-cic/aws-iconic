...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Containers/Res_Amazon-Elastic-Container-Service_CopiIoT-CLI_48"),
...
render.aliasName = "Amazon Elastic Container Service Copiiot Cli";
