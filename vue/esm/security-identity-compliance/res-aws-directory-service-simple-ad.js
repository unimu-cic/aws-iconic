...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Security-Identity-and-Compliance/Res_AWS-Directory-Service_Simple-AD_48"),
...
render.aliasName = "Aws Directory Service Simple Ad";
