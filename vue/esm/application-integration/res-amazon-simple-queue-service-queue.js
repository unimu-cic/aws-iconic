...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Application-Integration/Res_Amazon-Simple-Queue-Service_Queue_48"),
...
render.aliasName = "Amazon Simple Queue Service Queue";
