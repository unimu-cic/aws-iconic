...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Architecture/48/Arch_Amazon-Managed-Workflows-for-Apache-Airflow_48"),
...
render.aliasName = "Amazon Managed Workflows For Apache Airflow";
