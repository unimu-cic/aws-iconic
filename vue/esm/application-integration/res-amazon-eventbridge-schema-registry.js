...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Application-Integration/Res_Amazon-EventBridge_Schema-Registry_48"),
...
render.aliasName = "Amazon Eventbridge Schema Registry";
