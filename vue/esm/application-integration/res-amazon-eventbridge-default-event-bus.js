...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Application-Integration/Res_Amazon-EventBridge_Default-Event-Bus_48"),
...
render.aliasName = "Amazon Eventbridge Default Event Bus";
