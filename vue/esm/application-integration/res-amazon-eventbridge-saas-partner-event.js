...
function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("title", null, "Icon-Resource/Application-Integration/Res_Amazon-EventBridge_Saas-Partner-Event_48"),
...
render.aliasName = "Amazon Eventbridge Saas Partner Event";
