...
function ApplicationIntegrationAmazonEventbridgeSaasPartnerEvent({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ApplicationIntegrationAmazonEventbridgeSaasPartnerEvent);
