...
function ApplicationIntegrationResAmazonEventbridgeEvent({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ApplicationIntegrationResAmazonEventbridgeEvent);
ForwardRef.aliasName = "Amazon Eventbridge Event";
