...
function NetworkingContentDeliveryElasticLoadBalancingGatewayLoadBalancer({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(NetworkingContentDeliveryElasticLoadBalancingGatewayLoadBalancer);
