...
function NetworkingContentDeliveryAmazonVpcElasticNetworkInterface({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(NetworkingContentDeliveryAmazonVpcElasticNetworkInterface);
