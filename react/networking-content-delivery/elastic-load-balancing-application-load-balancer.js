...
function NetworkingContentDeliveryElasticLoadBalancingApplicationLoadBalancer({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(NetworkingContentDeliveryElasticLoadBalancingApplicationLoadBalancer);
