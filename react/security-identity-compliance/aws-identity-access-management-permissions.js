...
function SecurityIdentityComplianceAwsIdentityAccessManagementPermissions({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(SecurityIdentityComplianceAwsIdentityAccessManagementPermissions);
