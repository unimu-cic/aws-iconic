...
function ContainersAmazonElasticContainerServiceEcsServiceConnect({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ContainersAmazonElasticContainerServiceEcsServiceConnect);
