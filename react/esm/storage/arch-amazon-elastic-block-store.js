...
function StorageArchAmazonElasticBlockStore({
  title,
  titleId,
  ...props
}, svgRef) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    id: titleId
  }, "Icon-Architecture/48/Arch_Amazon-Elastic-Block-Store_48") : title ? /*#__PURE__*/React.createElement("title", {
    id: titleId
...
const ForwardRef = React.forwardRef(StorageArchAmazonElasticBlockStore);
ForwardRef.aliasName = "Amazon Elastic Block Store";
