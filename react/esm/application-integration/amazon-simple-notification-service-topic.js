...
function ApplicationIntegrationAmazonSimpleNotificationServiceTopic({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ApplicationIntegrationAmazonSimpleNotificationServiceTopic);
