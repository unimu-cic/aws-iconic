...
function ApplicationIntegrationAmazonSimpleNotificationServiceEmailNotification({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ApplicationIntegrationAmazonSimpleNotificationServiceEmailNotification);
