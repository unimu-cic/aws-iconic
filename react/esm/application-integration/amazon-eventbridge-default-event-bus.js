...
function ApplicationIntegrationAmazonEventbridgeDefaultEventBus({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ApplicationIntegrationAmazonEventbridgeDefaultEventBus);
