...
function ManagementGovernanceResAwsCloudformationStack({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(ManagementGovernanceResAwsCloudformationStack);
ForwardRef.aliasName = "Aws Cloudformation Stack";
