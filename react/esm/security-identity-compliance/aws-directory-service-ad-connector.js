...
function SecurityIdentityComplianceAwsDirectoryServiceAdConnector({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(SecurityIdentityComplianceAwsDirectoryServiceAdConnector);
