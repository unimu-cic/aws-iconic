...
function SecurityIdentityComplianceArchAwsCertificateManager({
  title,
  titleId,
  ...props
}, svgRef) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    id: titleId
  }, "Icon-Architecture/48/Arch_AWS-Certificate-Manager_48") : title ? /*#__PURE__*/React.createElement("title", {
    id: titleId
...
const ForwardRef = React.forwardRef(SecurityIdentityComplianceArchAwsCertificateManager);
ForwardRef.aliasName = "Aws Certificate Manager";
