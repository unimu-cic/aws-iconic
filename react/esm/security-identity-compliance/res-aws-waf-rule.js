...
function SecurityIdentityComplianceResAwsWafRule({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(SecurityIdentityComplianceResAwsWafRule);
ForwardRef.aliasName = "Aws Waf Rule";
