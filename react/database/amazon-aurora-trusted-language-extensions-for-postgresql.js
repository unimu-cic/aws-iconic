...
function DatabaseAmazonAuroraTrustedLanguageExtensionsForPostgresql({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = React.forwardRef(DatabaseAmazonAuroraTrustedLanguageExtensionsForPostgresql);
